...
from mods.texture import *
TEXTURE_PATH = 'textures/blocks/' + texture_pack + '.png'
#blocks register
GRASS = tex_coords((1, 0), (0, 1), (0, 0))
SAND = tex_coords((1, 1), (1, 1), (1, 1))
BRICK = tex_coords((2, 0), (2, 0), (2, 0))
STONE = tex_coords((2, 1), (2, 1), (2, 1))
WOOD = tex_coords((3, 2), (3, 2), (3, 1))
LEAF = tex_coords((3, 0), (3, 0), (3, 0))
WATER = tex_coords((0, 2), (0, 2), (0, 2))
ROCK = tex_coords((1, 2), (1, 2), (1, 2))
PLACE = tex_coords((0, 3), (0, 3), (0, 3))
BEDROCK = tex_coords((1, 3), (1, 3), (1, 3))
OLDR = tex_coords((2, 2), (2, 2), (2, 2))
GLASS = tex_coords((2, 3), (2, 3), (2, 3))
...
class Window(pyglet.window.Window):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.inventory = [GRASS, SAND, WOOD, LEAF, ROCK, BRICK, OLDR, PLACE, GLASS, BEDROCK]
    ...
    def on_key_release(self, symbol, modifiers):
        ...
        if symbol == key.W:
            ...
            pyglet.image.get_buffer_manager().get_color_buffer().save('screenshots/' + str(random.randint(1, 99999999999999999999)) + '.png')
        elif symbol == key.Y:
            time_world +=200
        elif symbol == key.F6:
